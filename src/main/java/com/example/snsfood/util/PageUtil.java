...
public class PageUtil {
    ...
    private long endPage;  //마지막페이지
    private String queryString;

    private String searchType;
    private String searchValue;

    private String searchTypeSearchValue;

    public void setSearchTypeSearchValue(String searchType, String searchValue) {

        if(searchType.equals("") || searchValue.equals("")) {
            searchTypeSearchValue = "";
        } else {
            searchTypeSearchValue = "&searchType=" + searchType + "&searchValue=" + searchValue;
        }
    }

    public String getSearchTypeKeyword() {
        return searchTypeSearchValue;
    }


    public PageUtil(long totalCount, long pageSize, long pageIndex, String queryString, String searchType, String searchValue) {
    ...
    public String pager() {
        ...
        if (searchType != null && searchType.length() > 0 && searchValue != null && searchValue.length() > 0 ) {
            addQueryString = "&searchType=" + searchType +"&searchValue=" + searchValue;
        }
